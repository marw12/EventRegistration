...
export default {
  ...
  created: function () {
    ...
    .then(response => {
      ...
      this.organizers.forEach(organizer => this.getAssignations(organizer.name))
    })
  ...
  methods: {
    ...
    createEvent: function (newEvent) {
      ...
      if (this.newEvent.title) {
        AXIOS.post('/events/theatre/'.concat(newEvent.name), {}, {params: newEvent})
        .then(response => {
    ...
    assignEvent: function (personName, eventName) {
      ...
      .then(response => {
        organizer.eventsAttended.push(event)
        this.selectedOrganizer = '';
        this.selectedEventOrganizer = '';
        // selectedPersonPay = '';
        // selectedEventPay = '';
    ...
    payEvent: function (deviceId, amount) {
      ...
      AXIOS.post('/paypal/'.concat(deviceId), {}, {params: params})
      .then(response => {
        this.errorPay = '';
      })
      .catch(e => {
